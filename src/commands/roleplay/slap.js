...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const embed = new Discord.EmbedBuilder()
      ...
      .setColor("#CD1C6C")
      .setFooter({
        text: `${target.user.username} has been slapped by ${message.author.username} ${count} times!`,
      });

    message.reply({ embeds: [embed] });
  },
  interaction: roleplayInteraction("slap", "slap someone", { target: "required", command: () => module.exports }),
};
